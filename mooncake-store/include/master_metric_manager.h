...
class MasterMetricManager {
   ...
   private:
    ...
    ylt::metric::counter_t offload_queue_push_failures_;  // PutEnd offload queue push failures
    ylt::metric::gauge_t offloading_queue_size_;  // Current offload queue item count
    ylt::metric::gauge_t offloading_queue_limit_;  // Configured offload queue max capacity
